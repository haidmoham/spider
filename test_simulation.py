...
from simulation import FOOT_NAMES, JOINTS_PER_LEG, load_model, measured_state, neutral_targets, reset, set_targets, step
...
class SimulationCoreTests(unittest.TestCase):
    ...
    def test_reset_is_deterministic_and_has_six_foot_positions(self) -> None:
        ...
        self.assertEqual(first.joint_positions, (0.0, 0.0, 0.8) * 6)
    ...
    def test_targets_are_commands_not_measured_state(self) -> None:
        ...
        set_targets(self.data, (0.0, 0.1, 0.7) * 6)
        self.assertEqual(measured_state(self.model, self.data), before)
        step(self.model, self.data)
        self.assertEqual(tuple(self.data.ctrl), (0.0, 0.1, 0.7) * 6)
    ...
    def test_static_and_legacy_shuffle_failure_signatures_are_reproducible(self) -> None:
        ...
        self.assertAlmostEqual(self.data.qpos[2], 0.4923574936825748, places=10)
        self.assertAlmostEqual(self.data.qvel[2], -0.0001185374208320417, places=10)
        ...
        self.assertAlmostEqual(self.data.qpos[0], -1.6184754790624798e-13, places=10)
        self.assertAlmostEqual(self.data.qpos[1], 0.19854772186547454, places=10)
        self.assertAlmostEqual(self.data.qpos[2], 0.5463297428063706, places=10)
    ...
    def test_static_and_live_surfaces_share_the_neutral_reset(self) -> None:
        ...
        self.assertEqual(response["controls"], [0.0, 0.0, 0.8] * 6)
